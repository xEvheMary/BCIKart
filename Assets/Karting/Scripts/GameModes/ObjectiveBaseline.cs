...
public class ObjectiveBaseline : Objective
{
    ...
    private const string PLAYER_PREFS_BASELINE_LAP = "baselineLap";

    void Awake()
    {
        currentLap = 1;
        if (PlayerPrefs.HasKey(PLAYER_PREFS_BASELINE_LAP)){
            lapsToComplete = PlayerPrefs.GetInt(PLAYER_PREFS_BASELINE_LAP, 2);
        }
