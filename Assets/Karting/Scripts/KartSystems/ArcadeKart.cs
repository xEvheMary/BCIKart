...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (PlayerPrefs.HasKey(PLAYER_PREFS_KART_SPEED)){baseStats.TopSpeed = PlayerPrefs.GetInt(PLAYER_PREFS_KART_SPEED);}
            if (PlayerPrefs.HasKey(PLAYER_PREFS_KART_ACCEL)){baseStats.Acceleration = PlayerPrefs.GetInt(PLAYER_PREFS_KART_ACCEL);baseStats.CoastingDrag = PlayerPrefs.GetInt(PLAYER_PREFS_KART_ACCEL);}
        ...
        void GatherInputs()
        {
            ...
            {
                if(m_Inputs[i].IsActive() && m_Inputs[i] != null){
        ...
        public void PositionReset(Vector3 point){
